...
import static io.guywithglasses.invoicemanagement.enumeration.VerificationType.ACCOUNT;
import static io.guywithglasses.invoicemanagement.query.UserQuery.*;
...
public class UserRepositoryImpl implements UserRepository<User> {
    ...
    public User create(User user) {
        ...
        if(getEmailCount(user.getEmail().trim().toLowerCase()) > 0) throw new ApiException("Email already in use. Please use another email address and try again!");
        // Save new user
        try {
